        ...
        <div className="mt-10  w-full flex max-w-md mx-auto lg:mx-0">
          <div className="flex sm:flex-row flex-col gap-5 w-full">
            <div className="py-1 pl-6 w-full pr-1 flex gap-3 items-center text-heading-3 shadow-lg shadow-box-shadow
              ...
              <input type="text" value={input} onChange={handleInputChange} name="" id="" placeholder="import libraries in a Java className or save changes to all tabs" className="w-full py-3 outline-none bg-transparent"/>
